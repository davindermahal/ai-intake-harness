...
I filed the ticket from my phone. Walking back from lunch, half-distracted, one hand on a coffee. I
wrote a clear description, added two acceptance notes, and dragged the card into the right column in
the JIRA app.

Then I forgot about it.

By the time I sat down at my desk, a plan was waiting for me. I read it, approved it, and went to
make tea. A while later, a finished branch was waiting too — built, tested, ready to review. I never
